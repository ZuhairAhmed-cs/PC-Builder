...
export function ComponentCard({
  ...
  const handleAddToBuild = (e: React.MouseEvent) => {
    ...
    if (isSelected) {
      ...
      // Only auto-advance when adding a component, not removing
      onSelect?.();
    }
  };
    ...
    >
      ...
      >
        ...
        <CardContent className="p-4">
          ...
          {/* Title */}
          <h3 className="font-heading font-semibold text-sm mb-2 line-clamp-2 group-hover:text-neon-green transition-colors">
            {component.title}
          </h3>
